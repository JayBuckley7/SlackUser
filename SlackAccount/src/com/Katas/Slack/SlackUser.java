...
public class SlackUser extends AIOUser {
	...
	private com.Katas.Slack.user user;
	private com.Katas.Slack.profile profile;
	...
	/***
	 * populates the user object based on the Json it's handed If responce fails a
	 * property called error will fill with the error message.
	 * 
	 * @param reply
	...
	/**
	 * @return the users display name Formatted if available or a blank string if
	 *         not
	 */
	...
	/**
	 * @return the url of the users original image if available or a blank string if
	 *         not
	 */
